...
class agendaModel extends Model {
    ...
    protected $allowedFields = ['agenda_nama', 'agenda_deskripsi', 'agenda_mulai', 'agenda_selesai', 'agenda_tempat'
    , 'agenda_jam', 'agenda_gambar', 'agenda_posting', 'admin_nama'];
...
return $builder;*/
		return $this->table('agneda')->like('agenda_name', $cari)->orLike('agenda_tempat', $cari);
	}
