        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
                <div class="icon-box">
                    ...
                    <div class="section-title">
                        <h4>Visi Misi</h4>
                        <p class="">Teknik Pemeliharaan Mesin Otomasi </p>
                        <div class="btn22">
...
<div class="TPMO2">
    ...
    <section id="testimonialscontainergabungusaha2" class="testimonialscontainergabungusaha2">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item3">
                            ...
                            <div class="profile mt-auto">
                                ...
                                <img src="/assets/img/stiker/dr3.png" class="testimonial-img" alt="">
                                <h3>Jena Karlis</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item4">
                            ...
                            <div class="profile mt-auto">
                                ...
                                <img src="/assets/img/stiker/dr4.png" class="testimonial-img" alt="">
                                <h3>Matt Brandon</h3>
                            </div>
                        </div>
                    </div>
